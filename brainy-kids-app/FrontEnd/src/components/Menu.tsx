...
const menuItems = [
  {
    ...
    items: [
      ...
      { icon: '/attendance.png',    label: 'Attendance',    href: '/list/attendance',   visible: ['administrator', 'teacher', 'parent', 'student'], },
      { icon: '/calendar.png',      label: 'Événements',    href: '/list/evenements',   visible: ['administrator', 'teacher', 'parent', 'student'], },
      ...
      { icon: '/lesson.png',        label: "Clubs d'été",   href: '/list/clubs-ete',    visible: ['administrator'], },
    ],
  },
  {
    title: 'OTHER',
    items: [
      { icon: '/profile.png', label: 'Profile', href: '/profile', visible: ['administrator', 'teacher', 'parent', 'student'], },
      { icon: '/setting.png', label: 'Settings', href: '/settings', visible: ['administrator', 'teacher', 'parent', 'student'], },
      { icon: '/logout.png', label: 'Logout', href: '/logout', visible: ['administrator', 'teacher', 'parent', 'student'], },
    ],
  },
];
const Menu = () => {
